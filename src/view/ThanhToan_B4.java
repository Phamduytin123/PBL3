...
import Models.Trip;
import controller.Buoc4Listener;
...
public class ThanhToan_B4 extends JPanel {
	...
	public ThanhToan_B4(FormBookTicket fbt, InfoCustomer IC, int NumberSelectSeat, Bill bl, Bus bs, Trip trip ){
		this.GUI();
		this.fbt = fbt;
		this.IC = IC;

...
import Models.Route;
import Models.Trip;
import controller.TripListener;
...
public class PanelTrip extends JPanel {
	...
	public void GUI()
	{
		...
		btnSelect.addActionListener(new TripListener(this));
		add(btnSelect);
	...
	public void Init() throws SQLException
	{
		...
		this.lblInputCityStart.setText(DAOTrip.getInstance().getNameCityEnd(trip.getTripID()));

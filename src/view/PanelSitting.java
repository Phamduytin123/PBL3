...
import controller.BookTicketTang1Listener;
import controller.PanelSittingListener;
...
public class PanelSitting extends JPanel {
	...
	public void GUI()
	{
		...
		panel.setBounds(36, 29, 471, 434);
		add(panel);
		panel.setLayout(null);
		
		panel_1 = new JPanel();
		panel_1.setBackground(new Color(255, 255, 128));
		panel_1.setBounds(29, 57, 257, 318);
		panel.add(panel_1);
		...
		panel_2.setBounds(315, 67, 138, 131);
		panel.add(panel_2);
		...
		btnSelect.setBounds(315, 285, 138, 37);
		panel.add(btnSelect);
		...
		btn_Tang2.setBounds(162, 386, 89, 23);
		if(bus.getKindOfBus().equals("1 tầng"))
		{
		...
		lblNewLabel_3.setBounds(183, -7, 156, 45);

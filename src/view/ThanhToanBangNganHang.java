...
import controller.Buoc4AListener;

import javax.swing.ImageIcon;
import javax.swing.JButton;

public class ThanhToanBangNganHang extends JPanel {
	...
	public void GUI()
	{
		...
		ImageIcon icon = new ImageIcon(ThanhToanBangNganHang.class.getResource("/photo/Bank.jpg"));
		...
		icon = new ImageIcon(ThanhToanBangNganHang.class.getResource("/photo/BusImage.png"));
		img = icon.getImage();
	...
	public ThanhToanBangNganHang(FormBookTicket fbt) {
		this.fbt = fbt;
		this.GUI();
		Init();
	}
